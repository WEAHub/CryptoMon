...
import { TradesDataService } from './services/trades-data.service';
import { TradeAlertNotifyComponent } from './components/trade-alert-notify/trade-alert-notify.component';
